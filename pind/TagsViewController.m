...
- (id)initWithStyle:(UITableViewStyle)style
{
    ...
    if (self) {
        self.tabBarItem.image = [UIImage imageNamed:@"14-tag.png"];
    }
    return self;
}
...
- (void)viewDidLoad
{
    ...
    UIBarButtonItem *addTagButton = [[UIBarButtonItem alloc] initWithTitle:@"add tag" style:UIBarButtonItemStylePlain target:self action:@selector(addTag:)];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    PinsViewController *pinVC = [[PinsViewController alloc] init];
...
-(void) addTag:(id)sender {
    ...
    UINavigationController* naviVC = [[UINavigationController alloc] initWithRootViewController:addTagVC];
